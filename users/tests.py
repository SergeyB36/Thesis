...
class CustomUserTestCase(APITestCase):
    ...
    def test_create_user(self):
        ...
        user = User.objects.get(fullname="testuser")
    ...
    def test_unique_email(self):
        ...
        response = self.client.post(
            self.url, data={"fullname": "testuser1", "email": "testuser@test.com", "password": "1234"}, format="json"
        )
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        self.assertIn("email", response.data)

    def test_invalid_data_fullname(self):
        """Тест невалидных данных при создании"""
        response = self.client.post(self.url, data={"fullname": "", "email": "", "password": "123"}, format="json")
    ...
    def test_valid_data_fullname(self):
        """Тест валидных данных при создании"""
        response = self.client.post(
            self.url, data={"fullname": "valid", "email": "valid@user.com", "password": "1234"}, format="json"
        )
...
class CustomUserCreateAPIViewTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.url = reverse("users:register")
        self.valid_data = {"fullname": "testuser", "email": "testuser@test.com", "password": "1234"}
    ...
    def test_perform_create_method_called(self):
        ...
        serializer_data = {"fullname": "testuser", "email": "testuser@test.com", "password": "1234"}
...
class CustomUserManagementCommandsTestCase(APITestCase):
    def test_command_creates_superuser(self):
        ...
        self.assertEqual(user.fullname, "admin")
        self.assertTrue(user.check_password("1234"))
    ...
    def test_command_creates_user(self):
        """Тест: создание кастомной командой user"""
